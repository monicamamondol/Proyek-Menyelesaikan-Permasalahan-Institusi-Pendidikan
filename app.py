...
with st.form(key='input_form'):
    ...
    curricular_units_1st_sem_without_evaluations = st.number_input('Curricular Units 1st Sem Without Evaluations', min_value=0.0, max_value=30.0, value=float(default_curricular_units_1st_sem_without_evaluations))
    ...
    curricular_units_2nd_sem_without_evaluations = st.number_input('Curricular Units 2nd Sem Without Evaluations', min_value=0.0, max_value=32.0, value=float(default_curricular_units_2nd_sem_without_evaluations))
